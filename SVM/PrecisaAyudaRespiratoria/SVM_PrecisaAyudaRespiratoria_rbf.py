...
gamma = 10**gamma
param_grid = [{'svm__C': C, 'svm__kernel': kernel, 'svm__gamma': gamma}]  # Hay que acceder a los parametros del pipeline como estimator__parameter
...
y_col = 'Situación al alta de UCI.Precisa ayuda respiratoria'
